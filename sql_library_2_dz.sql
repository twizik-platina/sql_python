...
CREATE TABLE books (
    ...
    CONSTRAINT fk_book_genre FOREIGN KEY (genre_id) REFERENCES genres(id) ON DELETE RESTRICT ON UPDATE RESTRICT
);


INSERT INTO genres (name, description) VALUES 
    ('Фэнтези', 'Книги с магией, вымышленными мирами и приключениями'),
    ('Научная фантастика', 'Книги про технологии, космос, будущее и научные открытия'),
...
INSERT INTO books (title, author, publication_year, pages_count, rating, is_available, genre_id) VALUES 
